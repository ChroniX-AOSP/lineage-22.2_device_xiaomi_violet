git clone --depth=1 https://github.com/LineageOS-Violet/vendor_xiaomi_violet.git -b lineage-22.2 vendor/xiaomi/violet
git clone https://github.com/ChroniX-AOSP/kernel_xiaomi_violet.git -b main kernel/xiaomi/violet
